...
const testimonials = [
  {
    id: 1,
    quote:
      "Patient admissions used to take twenty minutes of paperwork. Now it's a two-minute check-in, and our front desk queue has practically disappeared.",
    boldPart: "our front desk queue has practically disappeared",
    name: "Dr. Ayesha Raza",
    title: "Medical Superintendent",
    company: "Shifa International Hospital, Lahore",
    initials: "AR",
  },
  {
    id: 2,
    quote:
      "Bed occupancy tracking was always a guessing game between wards. With MediCore, every bed status updates in real time, and we've cut patient wait times in half.",
    boldPart: "every bed status updates in real time",
    name: "Dr. Kamran Malik",
    title: "Chief Executive Officer",
    company: "Aga Khan Health Network, Karachi",
    initials: "KM",
  },
  {
    id: 3,
